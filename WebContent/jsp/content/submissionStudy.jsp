  ...
  <div class="container">
         ...
         <div class="pageNav">
          ...
          <s:submit action="saveAndAddStudy" value="Save And Add Another Study " class="saved btn btn-default add_field_button"/>
           <s:submit action="saveStudy" value="Save Study " class="saved btn btn-project-primary"/>
          <i class="fa fa-caret-right" style="color:#ffffff;"></i>
        </div>   
            ...
            <div style="display: block;" class="form-group row">
                              <div class="col-xs-12">
                                <label class="label_sn" for="Study Name">
                                  ...
                                  Study Name &nbsp; &nbsp; <a title="" data-original-title="" href="#" class="hoverOver" data-toggle="tooltip" data-placement="right" data-html="true" title="Name of the individual study or protocol under which institutional IRB approval was granted (e.g. The Nurses Health Study)" style="font-size: 12px;"><i class="fa fa-question-circle fa-1x" aria-hidden="true"></i></a>
                                </label>
                           ...
                           <s:textfield name="study.studyName" style="width: 78.7%" class="form-control2" placeholder="Enter Study Name" id="studyname" value="%{study.studyName}" maxlength="150">
                               ...
                               <div style="display: block;" class="form-group row">         
                       <div class="col-xs-12">
                                <label class="label_in" for="Institution">Institution &nbsp; &nbsp; <a title="" data-original-title="" href="#" class="hoverOver" data-toggle="tooltip" data-placement="right" data-html="true" title="Institution that has purview over the study or protocol and under which the IRB review occurred (e.g. Johns Hopkins School of Public Health)" style="font-size: 12px;"> <i class="fa fa-question-circle fa-1x" aria-hidden="true"></i></a></label>
                                        <div class="col-xs-12">
