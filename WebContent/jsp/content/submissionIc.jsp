			...
			<div class="qSpacing" style="margin-left: 30px;" id="icDiv" style="${map['icDiv'].style}">
			  ...
			  <!--  IC comments -->
	 		  <div class="form-group row  col-xs-12">
                ...
                <s:textarea class="col-md-12 form-control" style="overflow-y: scroll;" rows="3" maxlength="2000" id="instCertComments" value="%{instCertification.comments}" name="instCertification.comments" ></s:textarea>
