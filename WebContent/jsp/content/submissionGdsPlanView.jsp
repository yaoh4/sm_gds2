  ...
  <s:else>
   ...
   <s:if test="%{project.planComments != null}">
	  <tr>
	    ...
	    <tr>
        <td colspan="4"><textarea class="commentsClass" style="width: 100%; border: 0px solid #000000; overflow-y: scroll; resize: none;" readonly="readonly">${project.planComments}</textarea></td>
      </tr>
      <tr>
        <td style="white-space: nowrap">&nbsp;</td>
        <td colspan="4">&nbsp;</td>
