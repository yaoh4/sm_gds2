...
public class MailTemplate implements java.io.Serializable {
	...
	public MailTemplate(Long id, String subject, String body, Boolean activeFlag, Date createdDate,
			String createdBy) {
		this.id = id;
	...
	public MailTemplate(Long id, String shortIdentifier, String description, String subject, String body,
